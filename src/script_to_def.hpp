...
unordered_map<string, vector<string>> script_to_entity = {
	{
		"entities/buildings/boonhouse.tds",
		{"boonhouse_door"}
	},
	{
		"entities/buildings/cantina.tds",
		{"building", "table", "chair_left", "chair_right", "bar", "liquor_cabinet", "bookcase", "picture"}
	},
	{
		"entities/characters/hero.tds",
		{"boon"}
	},
	{
		"entities/characters/intro_police.tds",
		{"intro_police"}
	},
	{
		"entities/characters/wilson/init.tds",
		{"wilson"}
	},
	{
	...
	{
		"entities/outdoor_props/foliage.tds",
		{"tree", "cactus", "bush"}
	},
	{
		"entities/outdoor_props/tiles.tds",
